...
var coindetails = /** @class */ (function () {
    function coindetails(navCtrl, navParams, element, http, userdetailsProv, alertCtrl, callNumber) {
        var _this = this;
    ...
    coindetails.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad viewcardsdetails');
    };
    coindetails.prototype.ngOnInit = function () {
        var _this = this;
    ...
    coindetails.prototype.updateHeader = function () {
    ...
    /*Scroll Header End*/
    coindetails.prototype.createCode = function (qrdigits) {
        this.qrimage = this.qrdigits;
    };
    coindetails.prototype.cardnotificationapi = function (cardid) {
        var cardid = cardid;
    ...
    coindetails.prototype.ionViewWillLeave = function () {
        this.userdetailsProv.willenter = true;
    };
    coindetails.prototype.facebookclick = function () {
        if (this.userdetailsProv.CheckConnection()) {
            window.open(this.facebook);
        } //internet
    };
    coindetails.prototype.linkedinclick = function () {
        if (this.userdetailsProv.CheckConnection()) {
            window.open(this.linkedin);
        } //internet
    };
    coindetails.prototype.websiteclick = function () {
        if (this.userdetailsProv.CheckConnection()) {
            window.open(this.website);
        } //internet
    };
    coindetails.prototype.twitterclick = function () {
        if (this.userdetailsProv.CheckConnection()) {
            window.open(this.twitter);
        } //internet
    };
    coindetails.prototype.dialclick = function (businessNumber) {
        this.callNumber.callNumber(businessNumber, true)
            .then(function () { return console.log('Launched dialer!'); })
            .catch(function () { return console.log('Error launching dialer'); });
    };
    coindetails.prototype.getroundedcoins = function (coins) {
    ...
    ], coindetails.prototype, "navBar", void 0);
    coindetails = __decorate([
        IonicPage(),
        Component({
...
export { coindetails };
//# sourceMappingURL=coindetails.js.map